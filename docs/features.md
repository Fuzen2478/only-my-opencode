# only-my-opencode Features

---

## Agents: Your AI Team

only-my-opencode provides 10 specialized AI agents. Each has distinct expertise, optimized models, and tool permissions.
...
Customize agent models, prompts, and permissions in `only-my-opencode.json`. See [Configuration](configurations.md#agents).
...
only-my-opencode provides two browser automation providers, configurable via `browser_automation_engine.provider`:
