...
describe("disabled_mcps schema", () => {
  test("should accept built-in MCP names", () => {
    ...
    //#when
    const result = OnlyMyOpenCodeConfigSchema.safeParse(config)
...
describe("OnlyMyOpenCodeConfigSchema - browser_automation_engine", () => {
  test("accepts browser_automation_engine config", () => {
    ...
    // #when
    const result = OnlyMyOpenCodeConfigSchema.safeParse(input)
